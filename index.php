...
echo 'Historiographie théâtrale, OBVIL';
    ?></title>
...
else if ( !$path ) echo '<a href="http://obvil.paris-sorbonne.fr/projets/historiographie-theatrale-comparee-lepoque-moderne">Projet : '.$conf['title'].'</a>';
else {
